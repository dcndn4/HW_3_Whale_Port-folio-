...
# Plot beta trend
rolling_covariance = all_returns['Algo_1'].rolling(window=30).cov(all_returns['SP500'])
#%%
...
# hmmm -- trying this below instead
...
yr_all.reset_index(inplace=True)
...
#%%
#total_returns = pd.concat([all_returns.astype({'date': 'str'}), yr_all_returns.astype({'date': 'str'})], axis='columns', join = 'inner')
